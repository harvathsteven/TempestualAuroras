module.exports = {
  ...
  facebookAuth: true,
  facebook: {
    clientID: process.env.FACEBOOK_ID || '1438923229680003',
    clientSecret: process.env.FACEBOOK_SECRET || 'f844f6393caa2a73826e386cf4edfbaa',
  ...
  googleAuth: true,
  google: {
    clientID: process.env.GOOGLE_ID || '412976786146-oj3v3tq6qf2t8v25ne84f292u2u3m6mt.apps.googleusercontent.com',
    clientSecret: process.env.GOOGLE_SECRET || 'hq6AlexI2HmoRZ1HYzkjKbXI',
  ...
  linkedinAuth: true,
  linkedin: {
    clientID: process.env.LINKEDIN_ID || '75a539jmawfvoe',
    clientSecret: process.env.LINKEDIN_SECRET || 'LehVuM6Pq2zHB33g',
